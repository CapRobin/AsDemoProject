...
import com.andbase.library.model.AbAppProcessInfo;
import com.andbase.library.model.AbCPUInfo;
import com.andbase.library.model.AbProcessInfo;
import com.andbase.library.model.AbPsRow;
	...
	public static boolean requestSDCardPermission(Context context) {
		...
		if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED) {
			...
			if (ActivityCompat.shouldShowRequestPermissionRationale((Activity)context,
				...
				AbToastUtil.showToast(context,"SDCard访问权限被拒绝，请在设置-应用程序打开!");
				return false;
			} else {
				//进行权限请求
