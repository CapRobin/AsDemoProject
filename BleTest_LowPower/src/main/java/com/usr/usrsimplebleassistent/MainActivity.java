...
//        AnimateUtils.rotation(fabSearch, 0, 400, 300, null);
        ...
        Log.i("oncreate:MainActivity.mBluetoothAdapter",MainActivity.mBluetoothAdapter.toString());
        if (BluetoothLeService.mBluetoothAdapter != null)
        Log.i("oncreate:BluetoothLeService.mBluetoothAdapter",BluetoothLeService.mBluetoothAdapter.toString());
    ...
    public void searchDevice() {
        if (MainActivity.mBluetoothAdapter != null)
            Log.i("after:MainActivity.mBluetoothAdapter",MainActivity.mBluetoothAdapter.toString());
        if (BluetoothLeService.mBluetoothAdapter != null)
            Log.i("after:BluetoothLeService.mBluetoothAdapter",BluetoothLeService.mBluetoothAdapter.toString());
        if (!scaning) {
            scaning = true;
            searchAnimate();
        }
    ...
    public void onRefresh() {
        ...
        if (MainActivity.mBluetoothAdapter != null)
            Log.i("beforescan:MainActivity.mBluetoothAdapter",MainActivity.mBluetoothAdapter.toString());
        if (BluetoothLeService.mBluetoothAdapter != null)
            Log.i("befortscan:BluetoothLeService.mBluetoothAdapter",BluetoothLeService.mBluetoothAdapter.toString());
        startScan();
    }
    ...
    private void startScan() {
        ...
        if (MainActivity.mBluetoothAdapter != null)
            Log.i("scan:MainActivity.mBluetoothAdapter",MainActivity.mBluetoothAdapter.toString());
        if (BluetoothLeService.mBluetoothAdapter != null)
            Log.i("scan:BluetoothLeService.mBluetoothAdapter",BluetoothLeService.mBluetoothAdapter.toString());
    }
        ...
        public void onLeScan(final BluetoothDevice device, final int rssi,
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (MainActivity.mBluetoothAdapter != null)
                        Log.i("find:MainActivity.mBluetoothAdapter",MainActivity.mBluetoothAdapter.toString());
                    if (BluetoothLeService.mBluetoothAdapter != null)
                        Log.i("find:BluetoothLeService.mBluetoothAdapter",BluetoothLeService.mBluetoothAdapter.toString());
                }
            });
        }
    };
